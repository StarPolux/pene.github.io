function createFlower() {
    ...
    for (let j = 0; j < maxFlowers; j++) {
        ...
        flower.style.animation = `fadeInFlower 1s ease-in-out both, fadeOutFlower 0.5s ease-in-out both ${disappearanceTime - 0.5}s`;
        ...
        for (let i = 1; i <= 2; i++) {
            ...
            // Agrega una animación de salida a los pétalos con el mismo tiempo aleatorio de desaparición que el cuerpo principal
            petal.style.animation = `fadeInPetal 0.5s ease-in-out both, fadeOutPetal 0.5s ease-in-out both ${disappearanceTime - 0.5}s`;
        }
